...
#
#  File     vga_periph_mem_0_wave.tcl (Thu May 25 13:09:16 2017)
#
...
if { ![info exists tbpath] } { set tbpath "${ps}system" }
  ...
  wave add $tbpath${ps}vga_periph_mem_0${ps}interrupt_o -into $id
...
# wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_Clk -into $id
# wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_Rst -into $id
# wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_S_Clk -into $id
  wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_S_Read -into $id
# wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_S_Data -into $id
# wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_S_Control -into $id
# wave add $tbpath${ps}vga_periph_mem_0${ps}FSL_S_Exists -into $id
